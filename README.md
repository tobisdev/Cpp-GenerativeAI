...
Cpp-GenerativeAI is developed by [Tobias Huber](https://github.com/tobisdev) as part of the [IntelliDrive](https://github.com/tobisdev/IntelliDrive) project, contributing to advancements in AI-driven autonomous driving solutions.
